...
class DeclidedLetterEmail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        ->subject(str_replace('_', " ", config('app.name', 'Laravel')) . ' | declined')
        ->view('staff.mail.staff.apps.'.$this->data->lang.'.declinedLetter')
        ->with(
            [
                ...
                'declinedReazon' => $this->data->declinedReazon
            ]
        );
    }
}
