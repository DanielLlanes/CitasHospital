    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('file')) {
            foreach ($request->file('file') as $key => $img) {
                $destinationPath = storage_path('app/public').'/application/logistic';
                ...
                $imgUrl = "storage/application/logistic/$img_name";
