...
class ApiPartnersController extends Controller
{
    ...
    public function states(Request $request, $code)
    {
        if ($request->has('id')) {
    ...
    public function procedures(Request $request, $code)
    {
    ...
    public function packages(Request $request, $code)
    {
        $lang = 'es';
    ...
    public function checkData(Request $request, $code)
    {  
        $exist = Partner::where('code', $code);
        if ($exist) {
