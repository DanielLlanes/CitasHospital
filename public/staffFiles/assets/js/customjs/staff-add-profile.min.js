...
if (surgeryPerformedForm == 0) {surgeiesPerformed()}
...
$(document).on('click', '#addbtn', function(event) {
    ...
    if ($fistChild == 'surgeryPerformedForm') {surgeiesPerformed()}
});
...
$(document).on('submit', '#surgeryPerformedSubmit', function(event) {
    ...
    $.ajax({
        url: globalDeleteSurgeriesPerformed,
        method:"POST",
        data:formData,
        dataType:'JSON',
        contentType: false,
        ...
        processData: false,
        beforeSend: function(){
           let surgeryPerformedCount = $('#postgraduateStudiesForm > .cloned')
            $('.error').html('');
            $('.form-group').removeClass('has-error has-danger')
            surgeryPerformedCount .each(function(index, el) {
                $(this).find('input[name*="surgery_title"]').attr('id', 'surgery_title-'+index);
                $(this).find('input[name*="surgery_cant[]"]').attr('id', 'surgery_cant[]-'+index);
            });
        },
        success:function(data){
...
function workHistory(){
    ...
    workHistory += '<input type="text" class="form-control intLimitTextBox" name="job_from_year[]" placeholder="Job Title">';
    workHistory += '<div class="error text-danger"></div>';
    workHistory += '</div>';
    workHistory += '</div>';
    workHistory += '<div class="col-md-6">';
    ...
    workHistory += '<input type="text" class="form-control intLimitTextBox" name="job_to_year[]"id="simpleFormPassword" placeholder="Job Company">';
    workHistory += '<div class="error text-danger"></div>';
    workHistory += '</div>';
    workHistory += '</div>';
...
function educationBackground(){
    ...
    educationBackground += '<input type="text" class="form-control intLimitTextBox education_from_year" name="education_from_year[]">';
    educationBackground += '<div class="error text-danger"></div>';
    educationBackground += '</div>';
    educationBackground += '</div>';
    educationBackground += '<div class="col-md-6">';
    ...
    educationBackground += '<input type="text" class="form-control intLimitTextBox education_to_year" name="education_to_year[]"id="simpleFormPassword">';
    educationBackground += '<div class="error text-danger"></div>';
    educationBackground += '</div>';
    educationBackground += '</div>';
...
function postgraduateStudies(){
    ...
    postgraduateStudies += '<input type="text" class="form-control intLimitTextBox postgraduate_from_year" name="postgraduate_from_year[]">';
    postgraduateStudies += '<div class="error text-danger"></div>';
    postgraduateStudies += '</div>';
    postgraduateStudies += '</div>';
    postgraduateStudies += '<div class="col-md-6">';
    ...
    postgraduateStudies += '<input type="text" class="form-control intLimitTextBox postgraduate_to_year" name="postgraduate_to_year[]"id="simpleFormPassword">';
    postgraduateStudies += '<div class="error text-danger"></div>';
    postgraduateStudies += '</div>';
    postgraduateStudies += '</div>';
...
function updateCourses(){
    ...
    updateCourses += '<input type="text" class="form-control intLimitTextBox course_year" name="course_year[]">';
    updateCourses += '<div class="error text-danger"></div>';
    updateCourses += '</div>';
    updateCourses += '</div>';
...
function surgeiesPerformed(){
    ...
    delBtn += '<hr>'
    delBtn += '</div>'
    var surgeryPerformed = '';
    surgeryPerformed += '<div class="cloned" style="display: contents">';
    surgeryPerformed += '<div class="col-md-4">';
    surgeryPerformed += '<div class="form-group">';
    surgeryPerformed += '<label for="simpleFormEmail">Surgery Title</label>';
    surgeryPerformed += '<input type="text" class="form-control surgery_title" name="surgery_title[]" placeholder="Study Title">';
    surgeryPerformed += '<div class="error text-danger"></div>';
    surgeryPerformed += '</div>';
    surgeryPerformed += '<div class="form-group">';
    surgeryPerformed += '<label for="simpleFormEmail">SurgeryCount</label>';
    surgeryPerformed += '<input type="text" class="form-control surgery_cant uintTextBox" name="surgery_cant[]" placeholder="Study Title">';
    surgeryPerformed += '<div class="error text-danger"></div>';
    surgeryPerformed += '</div>';
    surgeryPerformed +=    delBtn
    surgeryPerformed += '</div>';
    surgeryPerformed += '</div>';

    $('#surgeryPerformedForm').append(surgeryPerformed);
}
