...
function surgeiesPerformed(){
    ...
    surgeryPerformed += '<input type="text" class="form-control surgery_title" name="surgery_title[]" placeholder="Cx Title">';
    ...
    surgeryPerformed += '<input type="text" class="form-control surgery_cant uintTextBox" name="surgery_cant[]" placeholder="Cx Title">';
    surgeryPerformed += '<div class="error text-danger"></div>';
    surgeryPerformed += '</div>';
