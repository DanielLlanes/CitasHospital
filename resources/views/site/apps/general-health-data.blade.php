...
<main id="main">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_sleeping_pills" id="smoke_yes" value="1" @if (old('do_you_take_sleeping_pills') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_take_sleeping_pills == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_sleeping_pills" id="smoke_no" value="0" @if (old('do_you_take_sleeping_pills') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_take_sleeping_pills == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_suffer_from_anxiety_or_depression" id="smoke_yes" value="1" @if (old('do_you_suffer_from_anxiety_or_depression') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_suffer_from_anxiety_or_depression == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_suffer_from_anxiety_or_depression" id="smoke_no" value="0" @if (old('do_you_suffer_from_anxiety_or_depression') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_suffer_from_anxiety_or_depression == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_pills_for_anxiety_or_depression" id="smoke_yes" value="1" @if (old('do_you_take_pills_for_anxiety_or_depression') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_take_pills_for_anxiety_or_depression == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_pills_for_anxiety_or_depression" id="smoke_no" value="0" @if (old('do_you_take_pills_for_anxiety_or_depression') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_take_pills_for_anxiety_or_depression == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_feel_under_stress" id="smoke_yes" value="1" @if (old('do_you_feel_under_stress') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_feel_under_stress == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_feel_under_stress" id="smoke_no" value="0" @if (old('do_you_feel_under_stress') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_feel_under_stress == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_erections_at_the_morning" id="smoke_yes" value="1" @if (old('do_you_have_erections_at_the_morning') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_erections_at_the_morning" id="smoke_no" value="0" @if (old('do_you_have_erections_at_the_morning') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_problems_getting_erections" id="smoke_yes" value="1" @if (old('do_you_have_problems_getting_erections') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_problems_getting_erections" id="smoke_no" value="0" @if (old('do_you_have_problems_getting_erections') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_problems_maintaining_an_erection" id="smoke_yes" value="1" @if (old('do_you_have_problems_maintaining_an_erection') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_have_problems_maintaining_an_erection" id="smoke_no" value="0" @if (old('do_you_have_problems_maintaining_an_erection') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_any_natural_remedy_for_erectile_dysfunction" id="smoke_yes" value="1" @if (old('do_you_take_any_natural_remedy_for_erectile_dysfunction') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_take_any_natural_remedy_for_erectile_dysfunction" id="smoke_no" value="0" @if (old('do_you_take_any_natural_remedy_for_erectile_dysfunction') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="has_medication_been_injected_for_dysfunction_erectile" id="smoke_yes" value="1" @if (old('has_medication_been_injected_for_dysfunction_erectile') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="has_medication_been_injected_for_dysfunction_erectile" id="smoke_no" value="0" @if (old('has_medication_been_injected_for_dysfunction_erectile') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_had_an_erection_longer_than_six_hours" id="smoke_yes" value="1" @if (old('have_you_had_an_erection_longer_than_six_hours') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_had_an_erection_longer_than_six_hours" id="smoke_no" value="0" @if (old('have_you_had_an_erection_longer_than_six_hours') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_suffer_from_penile_curvature" id="smoke_yes" value="1" @if (old('do_you_suffer_from_penile_curvature') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="do_you_suffer_from_penile_curvature" id="smoke_no" value="0" @if (old('do_you_suffer_from_penile_curvature') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="has_prp_been_injected_for_erectile_dysfunction" id="smoke_yes" value="1" @if (old('has_prp_been_injected_for_erectile_dysfunction') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="has_prp_been_injected_for_erectile_dysfunction" id="smoke_no" value="0" @if (old('has_prp_been_injected_for_erectile_dysfunction') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_received_stem_cell_treatment_for_erectile_dysfunction" id="smoke_yes" value="1" @if (old('have_you_received_stem_cell_treatment_for_erectile_dysfunction') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_received_stem_cell_treatment_for_erectile_dysfunction" id="smoke_no" value="0" @if (old('have_you_received_stem_cell_treatment_for_erectile_dysfunction') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_received_vascular_regeneration_therapy_with_low_intensity_wave_therapy_for_erectile_dysfunction" id="smoke_yes" value="1" @if (old('have_you_received_vascular_regeneration_therapy_with_low_intensity_wave_therapy_for_erectile_dysfunction') == "1") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '1') checked @endif>
                <label class="form-check-label" for="smoke_yes">Yes</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="have_you_received_vascular_regeneration_therapy_with_low_intensity_wave_therapy_for_erectile_dysfunction" id="smoke_no" value="0" @if (old('have_you_received_vascular_regeneration_therapy_with_low_intensity_wave_therapy_for_erectile_dysfunction') == "0") checked @elseif(!empty($patient ?? '') && $patient->do_you_have_erections_in_the_moring == '0') checked @endif>
                <label class="form-check-label" for="smoke_no">No</label>
            </div>
            @error('have_you_received_vascular_regeneration_therapy_with_low_intensity_wave_therapy_for_erectile_dysfunction')
                <span class="invalid-feedback" style="display: block!important;" role="alert">
                    <strong class="error">{{ $message }}</strong>
                </span>
            @enderror
