...
<head>
    ...
    <title>{{ 'J.L. Prado Partners' }} | @yield('title')</title>
    ...
    <style type="text/css">
        ...
        .partners_bg{
            background: -webkit-linear-gradient(top, #903533, #ce2828);
        }
    </style>
    @yield('styles')
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-color logo-dark">
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top" style="">
            @include('partners.commun.topBar')
        </div>
        <!-- end header -->
        <!-- start page container -->
        <div class="page-container">
            <!-- start sidebar menu -->
            @include('partners.commun.aside')
             <!-- end sidebar menu -->
            <!-- start page content -->
            ...
            <{{-- div class="chat-sidebar-container" data-close-on-body-click="false">
                @include('partners.commun.configPanel')
            </div> --}}
            <!-- end chat sidebar -->
        </div>
        <!-- end page container -->
        ...
        <div class="page-footer">
            @include('partners.commun.footer')
        </div>
        <!-- end footer -->
    </div>
        ...
        <script>
            ...
            lang = 'es'
            var user_id = "{{ auth()->guard('partners')->user()->id }}";
            if (lang == 'es') {
