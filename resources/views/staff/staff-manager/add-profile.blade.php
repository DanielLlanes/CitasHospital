                ...
                <div class="white-box">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fontawesome-demo" id="surgeriesPerfored">
                            <div id="biography">
                                <div class="row" style="flex-flow: column;">
                                    <h5 class="font-weight-bold mt-5 mb-3">Surgeries Performed:</h5>
                                    <form class="" id="suergeriesPerformedSubmit" enctype="multipart/form-data">
                                        <div id="suergeriesPerformedArea">
                                            <div class="row" id="suergeriesPerformedForm">
                                                {{-- <div class="col-4">
                                                    <div class="form-group">
                                                        <label>Surgery Title</label>
                                                        <input type="text" class="form-control mb-2 surgery_title" name="surgery_title" placeholder="Surgery Title" value="">
                                                        <label>Surgery Qty</label>
                                                        <input type="text" class="form-control mb-2 surgery_cant uintTextBox" name="surgery_cant" placeholder="Surgery cant" value="">
                                                    </div>
                                                    <div class="col-12" id="delbtn">
                                                        <div class="form-group text-right" id="delBtnDiv">
                                                            <button type="button" class="btn addBtnImg btn-success mr-1">@lang('Add surgery')</button>
                                                            <button type="button" class="btn delBtnImg btn-danger ml-1">@lang('Delete surgery')</button>
                                                        </div>
                                                        <hr>
                                                    </div>
                                                </div> --}}
...
$(document).on('click', '#addbtn', function(event) {
    ...
    if ($fistChild == 'suergeriesPerformedForm') {updateCourses()}
});
...
function upload_images(order){
    ...
    delBtn += '<button type="button" class="btn addBtnImg btn-success mr-1">Add image</button>'
    delBtn += '<button type="button" class="btn delBtnImg btn-danger ml-1">Delete image</button>'
    delBtn += '</div>'
    delBtn += '<hr>'
    delBtn += '</div>'
    var dropify = '';
...
function careerObjetive(){
    ...
    careerObjetive += '<button type="submit" id="agregate" class="btn btn-success">+ Upload Info</button>';
    careerObjetive += '</div>';
    careerObjetive += '</div>';
    careerObjetive += '<hr>';
...
function workHistory(){
    var delBtn =  '<div class="col-12" id="delbtn">'
    delBtn += '<div class="form-group text-right" id="delBtnDiv">'
    delBtn += '<button type="button" class="btn delBtn btn-danger">Delete</button>'
    delBtn += '</div>'
    delBtn += '<hr>'
    delBtn += '</div>'
    var workHistory = '';
...
function surgeiesPerformed(){
    var count = $('#suergeriesPerformedForm').length
    var delBtn =  '<div class="col-12" id="delbtn">'
    delBtn += '<div class="form-group text-right" id="delBtnDiv">'
    delBtn += '<button type="button" class="btn addBtnSurgery btn-success mr-1">Add surgery</button>'
    delBtn += '<button type="button" class="btn delBtnSurgery btn-danger ml-1">Delete surgery</button>'
    delBtn += '</div>'
    delBtn += '<hr>'
    delBtn += '</div>'
    var dropify = '';
    dropify += '<div class="col-md-3" id="">';
    dropify += '<div class="form-group">';
    dropify += '<label>Surgery Title</label>';
    dropify += '<input type="text" class="form-control mb-2 surgery_title" id="title_'+count+'" name="surgery_title" placeholder="Surgery Title" value="">';
    dropify += '<div class="error text-danger"></div>';
    dropify += '<label>Surgery Qty</label>'
    dropify += '<input type="text" class="form-control mb-2 surgery_cant uintTextBox" count="'+1+'" id="file_'+count+'" name="surgery_cant" placeholder="Surgery cant" value="">'
    dropify += '<div class="error text-danger"></div>';
    dropify += '</div>';
    dropify += delBtn;
    dropify += '</div>';

    $('#suergeriesPerformedForm').append(dropify);
}
