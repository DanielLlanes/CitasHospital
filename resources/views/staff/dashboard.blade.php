                    ...
                    <ul id="homeDoctorList" class="docListWindow small-slimscroll-style">
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc1.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc2.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc3.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc4.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc5.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
                        ...
                        <li>
                            <div class="prog-avatar">
                                <img src="{{ asset('staffFiles/assets/img/doc/doc6.jpg') }}" alt="" width="40" height="40">
                            </div>
                            <div class="details">
                                <div class="title">
